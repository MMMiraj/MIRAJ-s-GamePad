...
void loop() {
  if (bleGamepad.isConnected()) {
    ...
    // setAxes order is (x, y, z, rX, rY, rZ, slider1, slider2).
    // Right stick uses z/rZ here (the Windows convention for right
    // thumbstick) rather than rX/rY, which is what Android expects
    // instead - this mismatch was why the right stick's Y axis
    // wasn't registering even though the wiring tested out fine.
